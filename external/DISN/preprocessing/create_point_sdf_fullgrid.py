...
def create_sdf(sdfcommand, marching_cube_command, LIB_command, num_sample, bandwidth, res, expand_rate,
    ...
    for catnm in cats.keys():
        ...
        with Parallel(n_jobs=5) as parallel:
            ...
            (sdfcommand, marching_cube_command, cat_mesh_dir, cat_norm_sdf_dir, cat_sdf_dir, obj, res, iso_val, expand_rate, indx, ish5, norm, num_sample, bandwidth, max_verts,cat_id, g, reduce)
        ...
        # for (sdfcommand, marching_cube_command, cat_mesh_dir, cat_norm_sdf_dir, cat_sdf_dir, obj, res, iso_val, expand_rate, indx, ish5, norm, num_sample, bandwidth, max_verts,cat_id, g, reduce_lst) in zip(sdfcommand_lst,
        #     marching_cube_command_lst, cat_mesh_dir_lst, cat_norm_sdf_dir_lst, cat_sdf_dir_lst, list_obj,
...
if __name__ == "__main__":
    ...
    #  full set
    create_sdf("/private/home/shubhtuls/code/s2s/cachedir/disn/DISN/isosurface/computeDistanceField",
               "/private/home/shubhtuls/code/s2s/cachedir/disn/DISN/isosurface/computeMarchingCubes",
               "source /private/home/shubhtuls/code/s2s/cachedir/disn/DISN/isosurface/LIB_PATH", 274625, 0.1,
